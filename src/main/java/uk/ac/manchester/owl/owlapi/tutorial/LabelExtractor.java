...
public class LabelExtractor implements OWLAnnotationObjectVisitor {
    ...
    public void visit(OWLAnnotation annotation) {
         ...
         * multiple labels, the last one will be used.List<String> ancesGOID;
         */
        ...
        if (annotation.getProperty().isDeprecated()) {
            ...
            comment = c.parseBoolean();
            		}
            
        
        if (annotation.getProperty().getIRI().toString().indexOf("id")>0) {
            OWLLiteral d = (OWLLiteral) annotation.getValue();
            id = d.getLiteral();
        }
    }
