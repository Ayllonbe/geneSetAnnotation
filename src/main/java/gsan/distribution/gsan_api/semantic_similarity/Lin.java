...
public class Lin extends SemanticSimilarityONE {
	...
	public double method(String t1, String t2,GlobalOntology go) {
		...
		return (2.0*((double)mica.ICs.get(4))/((double)(go.allStringtoInfoTerm.get(t1).ICs.get(4)+go.allStringtoInfoTerm.get(t2).ICs.get(4))));
	}
}
