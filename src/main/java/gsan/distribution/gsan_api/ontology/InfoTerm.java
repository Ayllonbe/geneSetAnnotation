...
//	public InfoTerm (String id, String t, List<String> anc, List<String> desc,  List<String> f,List<String> p
//			,String rp,String rn,String regul,List<String> pOf,List<String> hp,double d){
//		this.id = id;
//		this.name=t;
//		this.is_a = new Link();
//		this.is_a.ancestors.addAll(anc);
//		this.is_a.descendants.addAll(desc);
//		this.is_a.parents.addAll(p);
//		this.is_a.childrens.addAll(f);
//		this.part_of = new Link();
//		this.part_of.parents.addAll(pOf);
//		
//		this.regulate = regul;
//		this.positiveR= rp;
//		this.negativeR = rn;
...
//	}
//	public InfoTerm (String id, String t, List<String> anc, List<String> desc,  List<String> f,List<String> p
//			,List<Double> ics, List<Double> prob, double d){
//		this.id = id;
//		this.name=t;
//		this.is_a = new Link();
//		this.is_a.ancestors.addAll(anc);
...
//		this.proteinsgenome = new HashSet<String>();
//		this.probability = new ArrayList<Double>(prob);
//		this.ICs  = new ArrayList<Double>(ics);
//		this.distancias = new Hashtable<String,Double>();
//		this.geneSet = new HashSet<String>();
//		this.genome = new HashSet<String>();
//		this.bits = new BitSet();
...
//	}
	...
	public InfoTerm(InfoTerm it){
		...
		this.top = it.top;
		this.sValueIC = it.sValueIC;
		this.aggregateIC = it.aggregateIC;
	}
...
//	
	...
	public void addICDesc(Double ic , Double prob){
		this.icdesc= ic;
		this.probdesc=prob;
